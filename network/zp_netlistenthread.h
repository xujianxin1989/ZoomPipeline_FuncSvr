...
{
	/**
     * @brief this class manages a listening-address. The object of
     * this class will be moved into a thread. this thread hold the
     * message-queue for zp_netListenThread object. Wait and Accept
     * method will run in its message-queue thread.
	 */
	...
	public:
        explicit zp_netListenThread(QString id,
